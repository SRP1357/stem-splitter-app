...
| `htdemucs_ft_{drums,bass,other,vocals}_fp16weights.onnx` | Fine-tuned specialist ONNX exports — the "Highest quality" mode |
| `htdemucs_6s_fp16weights.onnx` | 6-stem ONNX export (guitar + piano) — the "6 stems" mode |
